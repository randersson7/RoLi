package lib.libjcsi.src.net.slashie.libjcsi.jcurses;
...
import lib.libjcsi.src.net.slashie.util.Pair;
import lib.libjcsi.src.net.slashie.util.Position;
import lib.libjcsi.src.net.slashie.util.ReferenceParam;
